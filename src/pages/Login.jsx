      ...
      <div className="max-w-md w-full relative z-10">
        ...
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center space-x-2 mb-4">
            ...
            <span className="text-2xl font-bold text-gray-900 dark:text-white">SkillPilot AI</span>
          </Link>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-100 dark:border-gray-700">
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm text-indigo-600 hover:text-indigo-700 dark:text-indigo-400 font-medium">
                Forgot password?
              </a>
            </div>
          ...
          <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/30 border border-blue-200 dark:border-blue-700 rounded-lg">
            <p className="text-sm text-blue-800 dark:text-blue-300">
              <strong>Connected to Flask Backend</strong> - Create an account or login with your credentials.
            </p>
          </div>
        </div>
